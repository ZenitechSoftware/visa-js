...
describe("visa.js check", () => {
  ...
  context("Object attributes", () => {
    ...
    context(
      "Subject attributes are matching but object attributes are NOT matching",
      () => {
        it("should NOT be authorized", () => {
          visa.policy({
            objects: {
  ...
  context("Referenced object attributes", () => {
    ...
    context(
      "Subject and multiple objects reference attributes are matching",
      () => {
        it("should be authorized", () => {
          visa.policy({
            objects: {
    ...
    context(
      "Provided mapRefsToObjects function returns number of objects that is not equal to number of refs passed",
      () => {
  ...
  context("Context attributes", () => {
    ...
    context(
      "Subject attributes are matching but context attributes are NOT matching",
      () => {
        it("should NOT be authorized", () => {
          visa.policy({
            objects: {
