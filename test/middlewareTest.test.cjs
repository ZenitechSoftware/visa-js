...
describe("visa.js middleware", () => {
  describe("express app is running and passport local strategy is used", () => {
    let app = null;
    let router = null;
    let server = null;
    ...
    describe("user role is matching", () => {
      it("should be authorized", () => {
        visa.policy({
          objects: {
            account: {
              operations: {
                open: (subject, _, context) =>
                  subject.role === "teller" &&
    ...
    describe("user is the owner of specific object", () => {
      it("should be authorized", () => {
        visa.policy({
          objects: {
            account: {
    ...
    describe("user is the owner of specific object referenced with :objectId Express param", () => {
      it("should be authorized", () => {
        visa.policy({
          objects: {
            account: {
    ...
    describe("user role is not matching", () => {
    ...
    describe("api method throws visa.Unauthorized", () => {
      it("should NOT be authorized and return 401", () => {
        visa.policy({
          objects: {
            account: {
